...
**Source:** `input_json/MissionTaskLotteryDataTable.json`.

**Row struct (from export):** `Class'GameDataTableRow_MissionTaskLottery'`
...
- **Id_MissionTask** — Unknown (AI - Possible description: Foreign key to another DataTable or asset row; suffix suggests mission task.)
