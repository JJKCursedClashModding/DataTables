...
**Source:** `input_json/BindingVowsLotteryDataTable.json`.

**Row struct (from export):** `Class'GameDataTableRow_BindingVowsLottery'`
...
- **Id_BindingVows** — Unknown (AI - Possible description: Foreign key to another DataTable or asset row; suffix suggests binding vows.)
